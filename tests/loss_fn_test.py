...
from temporal_fusion_transformer.src.quantile_loss import quantile_pinball_loss, quantile_mape
...
def test_quantile_mape():
    y_true = jax.random.uniform(PRNG_KEY, (8, 24, 1))
    y_pred = jax.random.uniform(PRNG_KEY, (8, 24, 1, 3))
    loss = quantile_mape(y_true, y_pred, quantiles)
