...
def optimize_hyperparams(
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        decay_steps = trial.suggest_float("decay_steps", low=0, high=1.)
        decay_alpha = trial.suggest_float("decay_alpha", low=0., high=1.)
        ema = trial.suggest_float("ema", low=0., high=1.)
        clipnorm = trial.suggest_float("clipnorm", low=0., high=1.)
